...
from dot_harness.client import (
...
class TestRunHarnessAsync:
    ...
    async def test_run_harness_async_with_tasks(
        ...
        from dot_harness.client import run_harness_async
    ...
    async def test_run_harness_async_invalid_file_raises_error(
        ...
        from dot_harness.client import run_harness_async
        from dot_harness.tasks import TaskFileError
...
class TestRunHarness:
    ...
    def test_run_harness_calls_async_version(
        ...
        from dot_harness.client import run_harness
