...
from dot_version.project_parser import PyProjectParser
...
class VersionManager:
    ...
    def _get_commits_since_last_tag(self, current: VersionInfo | None) -> list:
        ...
        """
        from dot_version.commit_parser import ConventionalCommitParser
    ...
    def _generate_changelog_entry(
        ...
        """
        from dot_version.changelog import ChangelogGenerator
