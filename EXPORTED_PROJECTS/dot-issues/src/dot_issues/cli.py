...
from dot_issues.adapters import UnitOfWork, create_db_engine
from dot_issues.config import get_db_url, is_debug_mode
...
from dot_issues.templates import TemplateManager
...
def update(
    ...
    """
    from dot_issues.domain.entities import InvalidTransitionError
...
def epic_set(
    ...
    with Session(engine) as session:
        uow = UnitOfWork(session)
        from dot_issues.services import IssueService
...
def deps_add(
    ...
    """
    from dot_issues.domain.entities import DependencyType
...
def instructions_apply(
    ...
    """
    from dot_issues.templates import TemplateParseError
...
def search_index_create() -> None:
    ...
    """
    from dot_issues.config import DbIssuesConfig
