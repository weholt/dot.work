...
from dot_issues.cli import app
from dot_issues.domain.entities import IssuePriority, IssueType
from dot_issues.services import EpicService, IssueService, TemplateService
from dot_issues.templates import (
    InstructionTemplate,
