...
from dot_work.knowledge_graph.search_fts import ScopeFilter, search
from dot_work.knowledge_graph.search_semantic import ScopeFilter as SemanticScopeFilter
