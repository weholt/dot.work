"""Unit tests for dot_work.knowledge_graph.ids module."""

from __future__ import annotations

import pytest

from dot_work.knowledge_graph.ids import (
    CROCKFORD_ALPHABET,
...
class TestCollisionResolution:
    ...
    def test_max_attempts_raises_error(self) -> None:
        ...
        for nonce in range(MAX_COLLISION_ATTEMPTS):
            ...
            from dot_work.knowledge_graph.ids import _compute_short_id_from_full
