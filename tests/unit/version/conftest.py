...
def mock_git_repo(temp_dir: Path) -> Generator[Mock, None, None]:
    ...
    # Mock tags
    mock_tag1 = Mock()
    mock_tag1.name = "v2025.01.001"
    mock_tag1.commit.hexsha = "abc123"
    mock_tag1.commit.author.name = "Test Author"
    mock_tag1.commit.committed_datetime = "2025-01-01T00:00:00Z"

    mock_tag2 = Mock()
    mock_tag2.name = "v2025.01.002"
    mock_tag2.commit.hexsha = "def456"
    mock_tag2.commit.author.name = "Test Author"
    mock_tag2.commit.committed_datetime = "2025-01-02T00:00:00Z"
