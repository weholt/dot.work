...
from dot_work.knowledge_graph import __version__
...
def ingest(
    ...
    from dot_work.knowledge_graph.graph import build_graph
...
def outline(
    ...
    from dot_work.knowledge_graph.graph import get_node_tree
...
def search(
    ...
    from dot_work.knowledge_graph.search_fts import search as fts_search
...
def expand(
    ...
    from dot_work.knowledge_graph.render import render_node
