"""Default templates for repo-agent instruction files.

This module provides default markdown templates with frontmatter configuration
for generating new instruction files. The templates include all configuration
options with sensible defaults and helpful comments.
"""
