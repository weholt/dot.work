---
output: markdown
filename: .github/prompts/first-circle.md
title: Focused Project Template / Retrofit Guide
---

# Focused Project Template / Retrofit Guide
...
├─ .gitignore            # includes project-docs/agent/
...
* **technical-requirements/**: Business requirements, functional specifications, API contracts, and system architecture documents
* **implementation-plans/**: Detailed implementation roadmaps, sprint plans, and development phases
* **task-lists/**: Current work items, backlog, completed tasks, and project tracking
* **agent/**: Temporary agent working files (automatically gitignored)
  - Testing scripts and cleanup utilities
  - Agent-generated summaries and analysis
  - Temporary data processing files
  - Debug logs and diagnostic information
  - Any files intended solely for agent use### Documentation Guidelines

* **Human Documentation**: Technical specs, requirements, and implementation plans go in respective folders
* **Agent Working Files**: All temporary agent files must go in `project-docs/agent/`
* **Project Root Minimalism**: Avoid writing files to the project root - use appropriate project-docs subdirectories
* **Summary Placement**:
  - Human-readable summaries → appropriate project-docs subfolder
  - Agent-only summaries → `project-docs/agent/`
* **Git Integration**: The `project-docs/agent/` folder is automatically added to .gitignore
...
  - Temporary agent files → `project-docs/agent/`
	  - This includes all summaries, test scripts, fix scripts etc
  - Documentation → appropriate `project-docs/` subfolder
...
   - Write analysis summary to `project-docs/agent/analysis-[timestamp].md`
...
   - Write design summary to appropriate project-docs/ subfolder
...
   - Create any testing utilities in `project-docs/agent/`
...
   - Verify all agent working files are in `project-docs/agent/`
...
from src.project_slug.domain.ports import UserRepo, FileStore, UnitOfWork, Clock
...
from src.project_slug.domain.ports import UserRepo, UnitOfWork
...
from src.project_slug.adapters.db.sqlalchemy_repo import SqlAlchemyUserRepo, SqlAlchemyUoW
from src.project_slug.adapters.fs.s3_store import S3FileStore
from src.project_slug.adapters.time.system_clock import SystemClock
from src.project_slug.services.user_photos import UserPhotosService
...
import pytest
from src.project_slug.adapters.db.sqlalchemy_repo import SqlAlchemyUserRepo
