"""Unit tests for agent_review.config module."""
...
from agent_review.config import Config, get_config
...
class TestConfig:
    ...
    def test_default_values(self) -> None:
        ...
        config = Config()
        assert config.storage_dir == ".agent-review"
    ...
    def test_from_env_custom(self) -> None:
        ...
        env = {
            "AGENT_REVIEW_STORAGE_DIR": ".custom",
            "AGENT_REVIEW_BASE_REF": "develop",
            "AGENT_REVIEW_HOST": "0.0.0.0",
            "AGENT_REVIEW_PORT": "9000",
        }
