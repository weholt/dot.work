...
class TestOllamaEmbedder:
    ...
    @patch("kgshred.embed.ollama.urllib.request.urlopen")
...
class TestOpenAIEmbedder:
    ...
    def test_init_openrouter_base_url(self) -> None:
        ...
        assert embedder._base_url == "https://openrouter.ai/api/v1"
    ...
    def test_init_custom_base_url(self) -> None:
        ...
        assert embedder._base_url == "https://custom.api.com"
    ...
    @patch("kgshred.embed.openai.urllib.request.urlopen")
    def test_embed_single_text(self, mock_urlopen: MagicMock) -> None:
