...
╚════════════════════════════════════════════════════════════════════════════╝
    ...
    print(
        f"   If you query with focused context: ~{context_stats[0][1] * 0.75:.0f} tokens/request (avg)"
    )
    print(
        f"   Cost reduction (at $0.015/1K tokens): ~${(total_words * 0.75 - context_stats[0][1] * 0.75) * 0.015 / 1000:.4f} per request"
    )
    print()
