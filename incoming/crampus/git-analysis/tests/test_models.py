...
from git_analysis.models import (
    AnalysisConfig,
    AnalysisError,
    CacheEntry,
    ChangeAnalysis,
...
class TestFileChange:
    ...
    def test_file_change_binary(self):
        ...
        file_change = FileChange(path="data/image.png", change_type=ChangeType.ADDED, binary_file=True)
...
class TestCacheEntry:
    ...
    def test_cache_entry_expired(self):
        ...
        recent_entry = CacheEntry(key="recent_key", data={"test": "data"}, timestamp=recent_timestamp)
