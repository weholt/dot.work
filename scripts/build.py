...
class BuildRunner:
    ...
    def __init__(self, verbose: bool = False, fix: bool = False, run_integration: bool = False):
        ...
        self.src_path = self.project_root / "src" / "dot_work"
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Build script for dot-work")
